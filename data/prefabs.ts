    ...
    groups: [
      {
        ...
        fields: [
          ...
          {
            id: "field-79123221",
            label: "Experience grading",
            type: InputType.NUMBER,
            validationRules: [
              { type: ValidationRuleType.MIN_VALUE, value: -100 },
              { type: ValidationRuleType.MAX_VALUE, value: 10 },
            ],
            optional: false,
          },
          {
            id: "field-791232921",
            label: "How much would you recommend us?",
            type: InputType.MULTIPLE_CHOICE,
            options: {
              // to 30
              choices: [
            ...
            validationRules: [{ type: ValidationRuleType.IS_MULTIPLE_CHOICE }],
            optional: true,
          },
          {
            id: "field-7912329218",
